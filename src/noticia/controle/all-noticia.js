    ...
    $.ajax({
        ...
        success: function(dados){
            for (const dado of dados) {
                ...
                <p class="text-justify">${dado.corpo.substring(0, 200)}
                    <button id="${dado.idnoticia}" class="btn btn-primary btn-sm btn-view"><i class="mdi mdi-plus-circle">Ler mais</i></button>
                </p>
`)
            }
        }
