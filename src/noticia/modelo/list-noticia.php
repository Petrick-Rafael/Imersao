<?php
    ...
    if($conexao){
        ...
        //Preparar o comando sql para obter os dados da notícia
        $sql = "SELECT idnoticia, date_format(data_noticia,'%d/%m/%Y %H:%i:%s') as data_noticia, titulo FROM NOTICIAS WHERE 1=1 ";
        ...
        if( !empty( $filtro ) ){
            ...
            $sql .= " OR data_noticia LIKE '$filtro%' ";
